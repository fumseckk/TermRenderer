...
#define SLEEP_TIME 60  // In milliseconds. 100ms = 10fps
...
// - framerate: framerate of the generated video. Don't go too high,
// performance-heavy. 0 will set the default (15).
