...
#define CHG_FG_COLOR_TO(__c_struct) \
  printf(CSI "38;2;%d;%d;%dm", __c_struct.r, __c_struct.g, __c_struct.b);
#define CHG_BG_COLOR_TO(__c_struct) \
  printf(CSI "48;2;%d;%d;%dm", __c_struct.r, __c_struct.g, __c_struct.b);
